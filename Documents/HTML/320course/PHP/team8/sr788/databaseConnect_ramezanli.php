...
<?php 
	...
	require_once 'login_lastname.php'; // need to modify filename of login php file
	...
	*/
	...
	for ($j = 0 ; $j < $rows ; ++$j) {
		...
		if ($j <= 5) {
			...
			echo("<img src=\"http://whereru.rutgers.edu/thumb.php?id=$row[$id]&t=1&w=200&h=75\"</img>");
		}
	}
?>
